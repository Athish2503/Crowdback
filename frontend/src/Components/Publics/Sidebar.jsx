...
import { HouseDoor, PlusCircle, Ticket, BoxArrowRight, List, Calendar } from "react-bootstrap-icons";
...
const Sidebar = ({ handleLogout }) => {
  ...
  const menuItems = [
    ...
    { icon: <Calendar className="me-2" />, text: "Events", route: "/user-events" }, // Add Events link
  ];
