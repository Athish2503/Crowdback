...
const AuthoritiesLogin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      localStorage.setItem("authoritiesToken", response.data.token);
  ...
  return (
    <Container className="d-flex justify-content-center align-items-center min-h-screen">
      <Card className="shadow-lg p-4 w-96">
        <Card.Body>
          <h2 className="text-center text-2xl font-bold">Officials Login</h2>
...
export default AuthoritiesLogin;